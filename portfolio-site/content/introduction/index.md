...
{{< youtubeLite id="D_oLM2LVi38" label="Channel Intro" >}}

You can check out my professional history in the [chronology]({{< relref "chronology" >}}) section.
...
You can check out my competitive history in the [achievements]({{< relref "achievements" >}}) section.

Here's a frag-movie I made sometime back.

{{< youtubeLite id="cwHbTcnH2Nc" label="A CSGO Frag Movie" >}}

And lastly, I've always liked to write, and I've written a few pieces. 

You can check them out in the [blog]({{< relref "blog" >}}) section.
